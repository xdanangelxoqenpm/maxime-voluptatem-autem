# @xdanangelxoqenpm/maxime-voluptatem-autem [![](http://img.shields.io/npm/dm/@xdanangelxoqenpm/maxime-voluptatem-autem.svg?style=flat)](https://www.npmjs.org/package/@xdanangelxoqenpm/maxime-voluptatem-autem) [![Node.js CI](https://github.com/xdanangelxoqenpm/maxime-voluptatem-autem/actions/workflows/node.js.yml/badge.svg)](https://github.com/xdanangelxoqenpm/maxime-voluptatem-autem/actions/workflows/node.js.yml)

> Simple to use type-safe local JSON database 🦉
> 
> If you know JavaScript, you know how to use @xdanangelxoqenpm/maxime-voluptatem-autem.
...
```js
const post = { id: 1, title: '@xdanangelxoqenpm/maxime-voluptatem-autem is awesome', views: 100 }
...
{
  "posts": [
    { "id": 1, "title": "@xdanangelxoqenpm/maxime-voluptatem-autem is awesome", "views": 100 }
  ]
}
```
...
posts.filter((post) => post.title.includes('@xdanangelxoqenpm/maxime-voluptatem-autem')) // Filter by title
...
```sh
npm install @xdanangelxoqenpm/maxime-voluptatem-autem
```
...
```js
import { JSONFilePreset } from '@xdanangelxoqenpm/maxime-voluptatem-autem/node'
...
You can extend @xdanangelxoqenpm/maxime-voluptatem-autem with Lodash (or other libraries). To be able to extend it, we're not using `JSONPreset` here. Instead, we're using lower components.

```ts
import { Low } from '@xdanangelxoqenpm/maxime-voluptatem-autem'
import { JSONFile } from '@xdanangelxoqenpm/maxime-voluptatem-autem/node'
...
```js
import { LowSync } from '@xdanangelxoqenpm/maxime-voluptatem-autem'
import { JSONFileSync } from '@xdanangelxoqenpm/maxime-voluptatem-autem/node'
...
Holds your db content. If you're using the adapters coming with @xdanangelxoqenpm/maxime-voluptatem-autem, it can be any type supported by [`JSON.stringify`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify).
...
```js
import { JSONFile, JSONFileSync } from '@xdanangelxoqenpm/maxime-voluptatem-autem/node'
...
```js
import { Memory, MemorySync } from '@xdanangelxoqenpm/maxime-voluptatem-autem'
...
```js
import { LocalStorage, SessionStorage } from '@xdanangelxoqenpm/maxime-voluptatem-autem/browser'
...
```js
import { DataFile } from '@xdanangelxoqenpm/maxime-voluptatem-autem/node'
...
If you've published an adapter for @xdanangelxoqenpm/maxime-voluptatem-autem, feel free to create a PR to add it here.
...
```js
import { Adapter, Low } from '@xdanangelxoqenpm/maxime-voluptatem-autem'
import { TextFile } from '@xdanangelxoqenpm/maxime-voluptatem-autem/node'
